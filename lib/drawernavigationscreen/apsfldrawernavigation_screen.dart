...
class ApsflDrawerNavigationScreen extends StatefulWidget {
  const ApsflDrawerNavigationScreen({super.key});

  @override
  State<ApsflDrawerNavigationScreen> createState() =>
      _ApsflDrawerNavigationScreenState();
}

class _ApsflDrawerNavigationScreenState
    extends State<ApsflDrawerNavigationScreen> {
          ...
          const UserAccountsDrawerHeader(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AssetImage('assets/images/logos/apsfl_logo.png'),
              ),
            ),
          ),
          ListTile(
            ...
            child: ListTile(
              ...
              onTap: () {
                Navigator.of(context)
                  ...
                  return const ApsflNotificationsScreen();
                }));
              },
            ),
          ),
