...
class OntdetailtabScreen extends StatefulWidget {
  final int? caf_id; // Add a field to store caf_id
  const OntdetailtabScreen({super.key, this.caf_id});

  @override
  State<OntdetailtabScreen> createState() => _OntdetailtabScreenState();
}

class _OntdetailtabScreenState extends State<OntdetailtabScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Future<void> _customer_details_names() async {
    ...
    try {
      var url = Uri.parse(Constants.baseUrl +
          Apiservice.customer_details_ont +
