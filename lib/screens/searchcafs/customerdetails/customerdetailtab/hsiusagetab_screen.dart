...
class HsiusagetabScreen extends StatefulWidget {
  final int? caf_id; // Add a field to store caf_id

  const HsiusagetabScreen({super.key, this.caf_id});

  @override
  State<HsiusagetabScreen> createState() => _HsiusagetabScreenState();
}

class _HsiusagetabScreenState extends State<HsiusagetabScreen> {
  void initState() {
    super.initState();
  ...
  Future<void> _customer_details_names() async {
    ...
    try {
      var url = Uri.parse(Constants.baseUrl +
          Apiservice.customer_details_hsiusage +
