...
import 'package:apsfllmo/screens/enterprisecaf/datamodal/installationaddressdatamodal.dart';
...
class EpCafCpeinformationScreen extends StatefulWidget {
  final int? selectedPackageIndex;
  final EpCafInstallationAddress installationAddressDataFormat;
  final EpCafCustomerInformation customerInfoDataFormat;
  ...
  const EpCafCpeinformationScreen({
    Key? key,
  ...
  @override
  State<EpCafCpeinformationScreen> createState() =>
      _EpCafCpeinformationScreenState();
}

class _EpCafCpeinformationScreenState extends State<EpCafCpeinformationScreen> {
  ...
  Future<void> _provision() async {
    ...
    final String? flag_type = await storage.read(key: 'flag_type');
    final String? lmo_cd = await storage.read(key: 'lmo_cd');
    ...
    final Map<String, dynamic> requestBody = {
      "data": {
        ...
        "agnt_id": agent_id, // COMPLETED CHANGE AGENT ID
        "apsf_unq_id": 0, // * COMPLETED
        "apsfl_bbnl": flag_type == '1'
            ? '4'
            : '3', // * COMPLETED // TODO: here we will put 3 or 4 based on login, so if user is login as apsfl flag will be 1 we will put 4 and bbnl flag will be 0 and will put 3
        "blng_cntct_nm":
            "${widget.customerInfoDataFormat.organisationName}", // COMPLETED
        "blng_cycle_id": 0, // * COMPLETED
        "blng_dstrct_id":
            '${widget.installationAddressDataFormat.district}', // * COMPLETED
        "blng_eml1_tx": '', // * COMPLETED
        "blng_house_flat_no":
        ...
        "caf_type_id": 2, // * COMPLETED caf --> 1 , enterprice caf --> 2
        ...
        "custInfo": {
          ...
          "custmrTyp": "", // * COMPLETED
          "dob_dt":
              '${widget.customerInfoDataFormat.dateOfIncorporation} ', // * COMPLETED
          "frst_nm":
              '${widget.installationAddressDataFormat.buildingName}', // * COMPLETED
          "frqncy_id":
          ...
          "instl_pincode":
              '${widget.installationAddressDataFormat.pincode}', // * COMPLETED
          "instl_state": 1, // COMPLETED
          "instl_streetname":
              '${widget.installationAddressDataFormat.address}', // * COMPLETED
          "lst_nm": ' ', // * COMPLETED
          "loc_dstrct_id":
              '${widget.installationAddressDataFormat.district}', // * COMPLETED
          "loc_eml1_tx": '', // * COMPLETED
          ...
          "rltve_nm":
              "${widget.customerInfoDataFormat.organisationPerson}", // * COMPLETED //enterprise caf
          "tle_nm": "Mr" // * COMPLETED
        },
        "custmrTyp": "", // * COMPLETED
        "dob_dt":
            '${widget.customerInfoDataFormat.dateOfIncorporation}', // * COMPLETED
        "dprmnt_id": 2, // * COMPLETED 0 --> individual , 1 --> enterprise
        ...
        "iptv_bx_emi": null, // * COMPLETED
        "iptv_bx_own": null, // * COMPLETED
        "iptv_bx_srl_num": null, // * COMPLETED
        "iptv_bx_up_amt": null, // * COMPLETED //up_frnt_chrgs_at #7
        "iptv_mac_addr_tx": null, // * COMPLETED
        "iptv_mdl": null, // * COMPLETED
        "iptv_stpbx_id": null, // * COMPLETED
        "lst_nm": '', // * COMPLETED
        "lat": 0.0, // * COMPLETED
        ...
        "orgsn_cd":
            "${widget.customerInfoDataFormat.organisationCode}", // * COMPLETED only enterprise
        "pan_nu": "", // * COMPLETED
        "pop_id":
            '${widget.installationAddressDataFormat.popid}', // * COMPLETED
        "prnt_cstmr_id":
            "${widget.customerInfoDataFormat.custmr_id}", // * COMPLETED   from first api list
        "prv_Dtls": {
          ...
          "firstname":
              '${widget.customerInfoDataFormat.organisationName}', // * COMPLETED
          "fup":
              upStreamTrafficProfile, // * COMPLETED       check first api code
          "identityProofId":
              '${widget.customerInfoDataFormat.aadharNumber}', // * COMPLETED  // * COMPLETED entrprise --> 0
          ...
          "tps": mdl_dtls_tx, // ? NOT CORRECTLY FIGURED    TODO: FIXME:
