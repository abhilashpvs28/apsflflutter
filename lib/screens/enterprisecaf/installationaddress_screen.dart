import 'package:apsfllmo/screens/enterprisecaf/basepackages_screen.dart';
...
class EpCafInstallationAddressScreen extends StatefulWidget {
  final EpCafCustomerInformation customerInfo;

  const EpCafInstallationAddressScreen({super.key, required this.customerInfo});

  @override
  State<EpCafInstallationAddressScreen> createState() =>
      _EpCafInstallationAddressScreenState();
}

class _EpCafInstallationAddressScreenState
    extends State<EpCafInstallationAddressScreen> {
...
// bool _isLoading = false;
  Future<void> _oltsbstndetails() async {
    ...
    final apiUrl =
        'http://bss.apsfl.co.in/apiv1/olt/oltsbstndetails/$agent_id/4';
                      ...
                      onTap: () {
                        if (_validateForm()) {
                          ...
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) => EpCafBaseBackages(
