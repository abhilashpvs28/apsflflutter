import 'package:apsfllmo/screens/enterprisecaf/cpeinformation_screen.dart';
...
class EpCafBaseBackages extends StatefulWidget {
  final EpCafInstallationAddress installationAddressInfo;
  final EpCafCustomerInformation customerInfoDataFormat;
  const EpCafBaseBackages(
      {super.key,
      required this.installationAddressInfo,
      required this.customerInfoDataFormat});

  @override
  State<EpCafBaseBackages> createState() => _EpCafBaseBackagesState();
}

class _EpCafBaseBackagesState extends State<EpCafBaseBackages> {
  ...
  Future<void> _getPckgesByAgntId() async {
    ...
    final apiUrl =
        'http://bss.apsfl.co.in/apiv1/package/getPckgesByAgntId/$agent_id/2';
                        ...
                        onTap: () {
                          if (_selectedPackageIndex != null) {
                            ...
                            Navigator.of(context)
                              ...
                              return EpCafCpeinformationScreen(
